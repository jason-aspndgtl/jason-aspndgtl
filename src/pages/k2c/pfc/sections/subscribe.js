...
import CallToActionForm from 'pages/k2c/pfc/components/call-to-action-form';
  ...
  return (
    <Box as="section" sx={styles.section}>
      <Container>
        <SectionHeading
          sx={styles.heading}
          title="Go ahead, Give it a try"
          description="Get an instant rate and see if we are a good fit"
        />
        <CallToActionForm sx={styles.subscriptionForm} />
      </Container>
    </Box>
  );
};
