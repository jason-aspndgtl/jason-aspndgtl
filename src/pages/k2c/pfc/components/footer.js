...
import Logo from 'pages/k2c/pfc/components/logo';
      ...
      <Container>
        <Flex sx={styles.footerInner}>
          <Flex sx={styles.copyright}>
            ...
            <Text as="span">
              Developed by Aspen Digital Solutions, LLC<br/>
              <a color="#fff" href="https://www.freepik.com/vectors/people">People vector created by pch.vector - www.freepik.com</a>
            </Text>
          </Flex>
